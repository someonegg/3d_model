...
Run from the repository: npm run models:build -- coin-sacagawea
"""
...
PHOTO = Image.open(SOURCE / 'references/reference.jpg').convert('L').filter(ImageFilter.GaussianBlur(0.65))
